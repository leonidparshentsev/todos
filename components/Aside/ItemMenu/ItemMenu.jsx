...
export default function ItemMenu({id, title, openProjectBoard, activeProject}) {
    return (
        <li className={`${styles.list_menu__item} ${(activeProject === id ? styles.active : '')}`}
            onClick={() => openProjectBoard(id)}>
